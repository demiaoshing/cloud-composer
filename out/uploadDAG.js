...
function uploadFile(fileList, bucketName, filePath, destFileName, storage) {
    {
        var fileType = filePath.split(".").pop();
        var files = setupExt_1.returnlistFiles(storage, bucketName);
        if (fileType != "py") {
...
//# sourceMappingURL=uploadDAG.js.map